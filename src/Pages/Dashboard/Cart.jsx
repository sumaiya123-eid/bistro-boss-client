...
export default function Cart() {
  ...
  return (
    <div>
      ...
      {cart.length > 0 ?  <Link to="/dashboard/payment"> <button className="btn bg-[#D1A054] text-white ">PAY</button></Link> : <button disabled className="btn bg-[#D1A054] text-white ">PAY</button>}
      </div>
